...
void Verificar (void) {
    ...
    char matrizPerfeita[8][3][3] = {{{"123"},{"456"},{"78 "}}, // → ☑ ↓
                                    {{" 12"},{"345"},{"678"}}, // → ☑ ↓ ☆
                                    {{"167"},{"258"},{"34 "}}, // ↓ ☑ →
                                    {{" 56"},{"147"},{"238"}}, // ↓ ☑ → ☆
                                    {{"78 "},{"654"},{"123"}}, // → ☑ ↑
...
void ComoJogarTela (void) {
    ...
    limpar(3);
    printf ("\n[*] Você receberá uma matriz composta por nove espaços.");
    printf ("\n[*] Oito serão números, um será um espaço vazio.");
    printf ("\n[*] Você pode mover para Cima, Baixo, Esquerda e Direita.");
    printf ("\n[*] Seu objetivo é colocar os números na sequência correta.");
    printf ("\n[*] O espaço vazio é sua forma de controle.");
    limpar(3);
...
void TelaDeDicas (void) {
    ...
    printf ("[!] Dicas:");
    limpar(3);
    printf ("\n[*] Você pode controlar o jogo com C, E, B, D.\n");
    printf ("\n[*] Você pode controlar o jogo com W, A, S, D, o Padrão dos Jogos.\n");
    printf ("\n[*] Se você Verificou e nada aconteceu, provavelmente a Ordem não foi aceita.\n");
    printf ("\n[*] Caso tente se mover para um espaço que não existe, nada irá acontecer.\n");
    printf ("\n[*] Reiniciar o Jogo irá embaralhar a Matriz novamente.\n");
    printf ("\n[*] Você pode fazer \"Combos de Movimento\", ao inserir \"CE\"");
    printf ("\nou \"WA\" (Para Cima, e após Esquerda) você irá fazer os dois movimentos");
    printf ("\nem uma única jogada (P.S: Você não pode se mover Diagonalmente).");
    limpar(3);
    printf ("[DIGITE 1] Voltar ao Menu Inicial");
...
void TelaDeAviso (void) {
    ...
    limpar(3);
    printf ("[ENTER] Já fiz isso, posso Continuar.");
